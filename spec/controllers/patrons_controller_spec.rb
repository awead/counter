  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested patron" do
        ...
        Patron.any_instance.should_receive(:update_attributes).with({ "barcode" => "MyString" })
        put :update, {:id => patron.to_param, :patron => { "barcode" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the patron as @patron" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Patron.any_instance.stub(:save).and_return(false)
        put :update, {:id => patron.to_param, :patron => { "barcode" => "invalid value" }}, valid_session
        assigns(:patron).should eq(patron)
      end
